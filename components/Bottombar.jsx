  ...
  return (
    <footer className={styles.bottomBar}>
      <div className={styles.container}>
        <a
          href="https://github.com/alexlm78/alexlm78.github.io"
          target="_blank"
      ...
      <div className={styles.container}>
        <a href="https://www.linkedin.com/in/alexlm78/" target="_blank" rel="noopener">
          <div className={styles.section}>
            <LinkedinIcon className={styles.icon} />
            <p>Linkedin</p>
          </div>
        </a>
        <a href="https://github.com/alexlm78" target="_blank" rel="noopener">
          <div className={styles.section}>
